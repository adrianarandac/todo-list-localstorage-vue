  ...
  <main class="app">
    ...
    <section class="todo-list">
      ...
      <div class="list" id="todo-list">
        <div v-for="(todo, i) in todos_asc" :class="`todo-item ${todo.done && 'done'}`" :key="i">
          <label>
      ...
      <p class="signature">created by  <a class="black" href="https://www.adrianaranda.com" target="_blank">adrian aranda</a>.</p>
    </section>
    <section>
    </section>
  </main>
